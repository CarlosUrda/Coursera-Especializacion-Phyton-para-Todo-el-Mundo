...
# Buscar líneas que tengan una forma determinada, extrayendo su valor y 
# calculando la media total.
...
for linea in archivo:
    ...
    total += sum([int(valor) for valor in valores])

media = float(total) / cuentaValores
print "El archivo", nombreDeArchivo, "tiene", cuentaLineas, \
      "lineas que coinciden con", expresion
print "La suma de todos los valores es %f y la media es %f" % (total, media)     
